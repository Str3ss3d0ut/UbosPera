...
DEFAULTS = {
    ...
    'universe': "AAPL,MSFT,GOOGL,AMZN,NVDA,TSLA,NFLX,META,AMD,ADBE,LLY,AVGO,COST,CRM,JPM,V,MA,PG,WMT,GE,JNJ,CAH,UNH,ABBV,PEP,KO,MCD,LIN,QCOM,WDC,INTC,MU,ONDS,VOD,PFE,PFE",
    'vol_target': 15.0,
    'mc_sims': 1000,
